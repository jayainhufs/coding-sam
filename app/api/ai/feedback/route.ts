...
3.  주석 설명을 사용하지 말아야하며, 학생이 현재 작성 중인 코드의 맥락에 바로 이어지는 '다음 단계'의 코드 스니펫(snippet)만 제공하십시오.
4.  제시된 '스타일 프로필'을 반드시 준수해야 합니다.
5.  **1줄 ~ 2줄**만 제안하세요. 만약 반복문 내부더라도 무조건 1줄~2줄만 제안해야합니다.

### 출력 (Your Response)
[학생의 스타일을 모방하여, 입력 2의 코드를 논리적으로 이어받는 다음 단계의 코드 스니펫 (1~2줄)]`
  }
